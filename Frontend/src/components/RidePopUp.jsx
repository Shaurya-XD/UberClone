...
const RidePopUp = ({ ride, confirmRide, setridePopUpPanel, setconfirmRidePopUpPanel }) => {
    ...
    return (
        <div className="pt-2 p-4">
            <h2 className="text-center text-2xl font-bold pb-2 text-gray-900">New Ride Available!</h2>

            <div className="flex justify-between items-center bg-yellow-400 p-3 mx-1 mb-3 rounded-2xl shadow-sm">
            ...
            <div className="flex flex-col justify-between">
                ...
                <div className="flex justify-between items-center gap-3 mt-4">
                    <button
                        ...
                        className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 px-8 rounded-xl w-1/2 transition-colors"
                    >
                        Ignore
                    </button>
                    <button
                        ...
                        className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-xl w-1/2 transition-colors shadow-md"
                    >
                        Accept
                    </button>
                </div>
